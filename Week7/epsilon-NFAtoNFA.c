...
void main()
{
           ...
           scanf("%d",&noalpha);
           getchar();
           printf("\nWarning!!!\n1)letter e as epsilon\n2)\" e \" must be last character ,if it is present\n");
        ...
        printf("Equivalent NFA without epsilon transitions : \n");
        printf("-----------------------------------\n");
        printf("Start State : ");
